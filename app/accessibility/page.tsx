          ...
          <div className="lg:flex lg:justify-between lg:gap-4">
            ...
            <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
              <div>
                <h1>
                  <Link
                    href="/"
                    className="text-4xl font-bold tracking-tight text-neutral-white sm:text-5xl hover:text-tertiary-mid focus-visible:text-tertiary-mid transition-colors"
                  >
                    Gabriel Ferreira
                  </Link>
                </h1>

                <h3 className="mt-3 text-base font-medium tracking-tight text-neutral-white sm:text-lg">
                  Frontend Engineer
                </h3>
                  ...
                  <ul className="mt-16 w-max">
                    <li>
                      <a className="group flex items-center py-3" href="#about">
                        <span className="nav-indicator mr-4 h-px w-8 bg-neutral-mid group-hover:w-16 group-hover:bg-neutral-white group-focus-visible:w-16 group-focus-visible:bg-neutral-white motion-reduce:transition-none" />
            ...
            >
              ...
              <section
                ...
                aria-label="About me"
              >
                <div className="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-primary-dark/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
              ...
              >
                ...
                <div>
                  <ol className="group/list" aria-label="Work experience list">
                    <li className="mb-12">
                      <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                        ...
                        <div className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-neutral-mid sm:col-span-2">
                          2024 — Present
                        </div>
                        ...
                        <div className="z-10 sm:col-span-6">
                          <h3 className="font-medium leading-snug text-neutral-white">
                            <div>
                              <a
                                className="inline-flex items-baseline font-medium leading-tight text-neutral-white hover:text-tertiary-mid focus-visible:text-tertiary-mid  group/link text-base"
                          ...
                          >
                            <li className="mr-1.5 mt-2">
                              <div className="flex items-center rounded-full bg-tertiary-mid/10 px-3 py-1 text-xs font-medium leading-5 text-tertiary-light ">
                                React
                              </div>
                            </li>
                            <li className="mr-1.5 mt-2">
