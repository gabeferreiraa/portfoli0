          ...
          <div className="lg:flex lg:justify-between lg:gap-10">
            ...
            <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
              <div>
                ...
                <p className="mt-3 text-base font-medium tracking-tight sm:text-lg">
                  Frontend Engineer
                </p>
                  ...
                  <ul className="mt-16 w-max">
                    <li>
                      <a className="group flex items-center py-3" href="#about">
                        <span
                          className="nav-indicator mr-4 h-px w-8 bg-neutral-mid group-hover:w-16 group-hover:bg-neutral-white group-focus-visible:w-16 group-focus-visible:bg-neutral-white motion-reduce:transition-none"
                          aria-hidden="true"
                        />
            ...
            >
              ...
              >
                ...
                <ol aria-label="Work experience" className="group/list">
                  <li className="mb-12">
              ...
              <footer className="max-w-md pb-16 text-sm text-neutral-mid sm:pb-0">
                <p>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    aria-label="Inter typeface (opens in a new tab)"
                  >
                    Inter
                  </a>{" "}
                  typeface.
                ...
                {/* Optional: semantic contact (only keep if you want it) */}
                <address className="mt-6 not-italic">
                  <a
                    href="mailto:you@example.com"
                    className="font-medium text-neutral-light hover:text-tertiary-mid focus-visible:text-tertiary-mid transition-colors"
                    aria-label="Email Gabriel Ferreira"
                  >
                    you@example.com
                  </a>
                </address>
